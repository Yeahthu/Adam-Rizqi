...
MQTT_PORT = 8883
MQTT_TOPIC_TEMPERATURE = "dht/temperature"
MQTT_TOPIC_HUMIDITY = "dht/humandity"
MQTT_USERNAME = "adamn"
MQTT_PASSWORD = "Kepoyaw_1"
...
def on_message(client, userdata, msg):
    ...
    if topic == MQTT_TOPIC_TEMPERATURE:
        temp_data['temperature'] = str(payload)
    elif topic == MQTT_TOPIC_HUMIDITY:
        temp_data['humandity'] = str(payload)
    
   
    if 'temperature' in temp_data and 'humandity' in temp_data:
        data = {
            'timestamp': timestamp,
            'suhu': temp_data['temperature'],
            'humandity': temp_data['humandity']
        }
...
def add_dummy_data():
    ...
    for reading in readings:
        ...
        humidity = reading.get('humandity')
